...
class HeaderMenuPage {
  ...
  async navigateAndValidateReportItems() {
    ...
    const reportMenuList = [
      ...
      { name: 'Client Service Tracker', urlContains: 'client-service-tracker' },
      { name: 'Monthly Report For Prescriber', urlContains: 'monthly-report-for-prescriber' },
      { name: 'Staff Performance Report', urlContains: 'staff-performance-report' },
      { name: 'Groups Summary', urlContains: 'groups-summary' },
